...
export default function ReportsList() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-2">My Assigned Reports</h1>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2 overflow-x-auto">
                    {report.photos.map((photo, index) => (
                      <div
                        key={index}
                        className="w-20 h-20 bg-muted rounded-md shrink-0 flex items-center justify-center border"
                      >
            ...
            <CardHeader>
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <CardTitle className="text-xl mb-2">{selectedReport.title}</CardTitle>
                  <span
