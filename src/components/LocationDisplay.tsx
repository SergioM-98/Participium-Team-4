  ...
  return (
    <div className="mt-4 flex justify-center min-h-[36px]">
      {selected ? (
          ...
          {Array.isArray(selected) ? (
            <span>
              <span className="block sm:inline">
                Latitude: {selected[0].toFixed(5)},
              </span>
              <span className="block sm:inline">
                {" "}
                Longitude: {selected[1].toFixed(5)}
              </span>
            </span>
          ) : selected &&
            ...
            <span>
              <span className="block sm:inline">
                Latitude: {selected.lat.toFixed(5)},
              </span>
              <span className="block sm:inline">
                {" "}
                Longitude: {selected.lng.toFixed(5)}
              </span>
            </span>
          ) : (
        ...
        <span className="inline-block px-3 py-1 rounded-xl bg-gray-100/90 border border-gray-200 text-gray-400 font-mono text-xs sm:text-sm">
