...
describe("MessageController story 11", () => {
  ...
  describe("sendMessage", () => {
    ...
    it("should catch unexpected errors thrown by service and return failure", async () => {
      const mockRequest = {
        reportId: "1",
        senderId: "2",
        content: "Crash test",
      ...
      // Force the service to Throw/Reject, triggering the Controller's try/catch block
      mockInstance.sendMessage.mockRejectedValue(new Error("Unexpected crash"));
  ...
  describe("getReportMessages", () => {
    ...
    it("should catch unexpected errors thrown by service and return failure", async () => {
      ...
      // Force the service to Throw/Reject
      mockInstance.getReportMessages.mockRejectedValue(
      ...
      expect(response).toEqual({
        success: false,
        error: "Failed to get report messages",
      });
    });
  });
});
